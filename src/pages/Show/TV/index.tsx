    ...
    <div className='tv'>
      ...
      <div className="tv__meta">
        <div className="tv__meta_header">
          ...
          <a href={tv?.homepage} className="tv__meta_header__link">Homepage</a>
          <span className='tv__meta_header__idioma'>Original Language: {tv?.original_language}</span>
          <span className='tv__meta_header__temps'>Number of Seasons: {tv?.number_of_seasons}</span>
          <span className='tv__meta_header__lancamento'>First Air Date: {tv?.first_air_date}</span>
          <span className='tv__meta_header__nota'>Rating: {tv?.vote_average}</span>
        </div>
